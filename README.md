...
- **Payload:**
  ...
  | `created_at` | int64 | Unix-время создания конфигурации. |
  | `updated_at` | int64 | Unix-время последнего обновления или пополнения БЗ. |
...
- **Payload:**
  ...
  | `updated_at` | int64 | Unix-время последнего пересчёта параметров калибровки. |
